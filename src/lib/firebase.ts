...
export const DEFAULT_PAYMENT_SETTINGS: import('../types').PaymentSettings = {
  ...
  policyText: 'Online Orders: No Return • No Exchange • No Change',
  onlineOrderPolicy: 'Online Orders: No Return • No Exchange • No Change',
  offlineStorePolicy: 'Physical Store Purchases Only: Size exchange available in-store within 7 days with valid store invoice.',
