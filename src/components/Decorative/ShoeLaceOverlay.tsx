...
export const ShoeLaceOverlay: React.FC = () => {
  ...
  const hoverAnimDuration = `${Math.max(2.5, swingSpeedSec * 0.45)}s`;
  ...
  return (
    <div
      ...
      className="fixed z-30 pointer-events-none select-none origin-top transition-all duration-500 max-h-screen overflow-visible"
      aria-hidden="true"
    >
      <style>{`
        ...
        .animate-realistic-swing {
          ...
          animation: ${enablePhysicsAnimation ? `realistic-hanging-swing ${animDuration} cubic-bezier(0.42, 0, 0.58, 1) infinite` : 'none'};
          will-change: transform;
        }

        .animate-realistic-hover {
          transform-origin: 120px 0px;
          animation: ${enablePhysicsAnimation ? `realistic-hover-swing ${hoverAnimDuration} cubic-bezier(0.42, 0, 0.58, 1) infinite` : 'none'};
          will-change: transform;
        }
        ...
        .animate-lace-dangle {
          transform-origin: 118px ${laceLength}px;
          animation: ${enablePhysicsAnimation ? 'realistic-lace-dangle 7s ease-in-out infinite' : 'none'};
          will-change: transform;
        }
      ...
      <div
        ...
        onClick={handleClick}
        title="Marudhar Fashion Point - Luxury High-Top Sneaker (Click to Kick)"
      >
        {imageUri ? (
          /* =========================================================
             CUSTOM UPLOADED SNEAKER IMAGE WITH REALISTIC LACES & PHYSICS
             ========================================================= */
          <div className="relative flex flex-col items-center">
            {/* Top Mount Bracket & Suspension Laces SVG */}
            <svg
              width="240"
              height={laceLength}
              ...
              className="w-[100px] sm:w-[140px] md:w-[180px] lg:w-[220px] h-auto"
            >
              <defs>
              ...
              {/* Chrome Fixing Bracket */}
              <rect x="108" y="0" width="24" height="10" rx="3" fill="url(#gunmetalEyeletGradCustom)" />
              <circle cx="120" cy="10" r="5" fill="none" stroke="url(#gunmetalEyeletGradCustom)" strokeWidth="3" />
              <circle cx="120" cy="10" r="2" fill="#0B8F63" />

              {/* Suspension Cotton Laces Strands */}
              <path d={`M 116 12 Q 114 ${laceLength / 2}, 108 ${laceLength}`} stroke="#FFFFFF" strokeWidth="5.5" strokeLinecap="round" fill="none" />
              <path d={`M 116 12 Q 114 ${laceLength / 2}, 108 ${laceLength}`} stroke="#0B8F63" strokeWidth="1.2" strokeDasharray="3 3" fill="none" />

              <path d={`M 124 12 Q 126 ${laceLength / 2}, 132 ${laceLength}`} stroke="#F5F5F5" strokeWidth="5.5" strokeLinecap="round" fill="none" />
              <path d={`M 124 12 Q 126 ${laceLength / 2}, 132 ${laceLength}`} stroke="#0B8F63" strokeWidth="1.2" strokeDasharray="3 3" fill="none" />

              {/* Knot at bottom of laces */}
              <ellipse cx="120" cy={laceLength - 5} rx="12" ry="7" fill="#0B8F63" />
              <ellipse cx="120" cy={laceLength - 5} rx="9" ry="4" fill="#FFFFFF" opacity="0.8" />
            </svg>
            ...
            <div
              ...
              className="relative transition-transform duration-300 drop-shadow-[0_20px_30px_rgba(0,0,0,0.35)]"
            >
              <img
                src={imageUri}
                alt="Marudhar Custom High-Top Sneaker"
                referrerPolicy="no-referrer"
                className="w-full h-auto object-contain transform -rotate-12 filter contrast-105"
              />
            </div>
          </div>
        ) : (
          /* =========================================================
             BUILT-IN ULTRA-REALISTIC VECTOR / 3D HIGH-TOP SNEAKER
             ========================================================= */
          <svg
            width="240"
            height="540"
          ...
          >
            <defs>
              ...
              {/* 3. White Tumbled Leather Upper Gradient */}
              ...
              {/* 8. Metallic Gunmetal Eyelet Shader */}
              ...
              {/* 10. Photorealistic Multi-Layer Shadow */}
              ...
              {/* 12. Soft Contact Ambient Occlusion */}
            ...
            <g filter="url(#photorealSneakerShadow)">
              ...
              {/* 1. BROWSER TOP EDGE MOUNTING BRACKET */}
              ...
              {/* 2. LONG SUSPENSION COTTON SHOELACES */}
              <path
              ...
              {/* 3. REALISTIC TIED KNOT & BOW LOOPS AT INSTEP */}
              <path
              ...
              {/* 4. ULTRA-REALISTIC HIGH-TOP BASKETBALL SNEAKER BODY */}

              {/* A. Padded Ankle Collar Interior Opening */}
              <ellipse
                cx="70"
                cy="295"
                rx="28"
              ...
              <path
                ...
                opacity="0.4"
              />
              {/* Toe Box Ventilation Perforations */}
              ...
              {/* F. Original Signature Marudhar Curved Racing Swoop */}
              <path
              ...
              {/* G. Precision Double Stitching Lines */}
              <path
              ...
              {/* I. Sculpted Rubber Midsole & Outsole Wall */}
              <path
