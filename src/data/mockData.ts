...
export const DEFAULT_HERO_CONTENT: HeroContent = {
  ...
  customHeroImageUrl: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?auto=format&fit=crop&w=1200&q=80',
  heroImageFit: 'cover',
...
export const DEFAULT_SOCIAL_PLATFORMS: import('../types').SocialPlatformConfig[] = [
  ...
  },
  {
    ...
    profileUrl: 'https://facebook.com/marudharfashionpoint',
    customIcon: 'Facebook',
  ...
  },
  {
    ...
    enabled: true,
    username: 'marudharfashionpoint',
    profileUrl: 'https://youtube.com/@marudharfashionpoint',
    customIcon: 'Youtube',
  ...
  },
  {
    ...
    name: 'Telegram',
    enabled: false,
    username: 'marudharfashion',
    profileUrl: 'https://t.me/marudharfashion',
    customIcon: 'Send',
  ...
  },
  {
    ...
    enabled: false,
    username: 'marudharfashion',
    profileUrl: 'https://x.com/marudharfashion',
    customIcon: 'Twitter',
  ...
  },
  {
    ...
    name: 'Snapchat',
    enabled: false,
    username: 'marudhar_fashion',
    profileUrl: 'https://snapchat.com/add/marudhar_fashion',
    customIcon: 'Camera',
  ...
  },
  {
    ...
    name: 'LinkedIn',
    enabled: false,
    username: 'marudhar-fashion-point',
    profileUrl: 'https://linkedin.com/company/marudhar-fashion-point',
    customIcon: 'Linkedin',
  ...
  },
  {
    ...
    enabled: true,
    username: 'marudhar-footwear',
    profileUrl: 'https://g.page/marudhar-footwear/review',
    customIcon: 'MapPin',
...
export const DEFAULT_SOCIAL_MEDIA_CENTER_CONFIG: import('../types').SocialMediaCenterConfig = {
  ...
  instagramReelsPhoneEnabled: true,
  instagramReelsPhoneTitle: 'See Us on Instagram • मरुधर फैशन पॉइंट ऑन इंस्टाग्राम',
  instagramReelsPhoneSubtitle: 'Latest looks, trending reels & store moments — follow us @marudharfashionpoint',
  instagramReelsPhoneAccountHandle: '@marudharfashionpoint',
  instagramReelsPhoneAccountUrl: 'https://www.instagram.com/marudharfashionpoint/',
  instagramReelsList: [
    {
      id: 'reel_1',
  ...
  youtubeVideos: [
    ...
    { id: 'yt2', title: 'Sneaker Restoration and Durability Testing: Marudhar Special Run', thumbnailUrl: 'https://images.unsplash.com/photo-1520639888713-7851133b1ed0?auto=format&fit=crop&w=300&q=80', views: '15K views', duration: '8:30', publishedAt: '1 month ago', videoUrl: 'https://youtube.com/watch?v=mockyt2' },
    { id: 'yt3', title: 'Customer Experience Spotlight: Viju Bhai Explains Sizing and Comfort Design', thumbnailUrl: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=300&q=80', views: '8.2K views', duration: '15:20', publishedAt: '2 months ago', videoUrl: 'https://youtube.com/watch?v=mockyt3' }
  ],
  youtubeShorts: [
    { id: 'sh1', title: 'Mojari Crafting Process live from Jodhpur! 👑🔨 #shorts #craftsmanship', thumbnailUrl: 'https://images.unsplash.com/photo-1584735935682-2f2b69dff9d2?auto=format&fit=crop&w=200&q=80', views: '120K views', duration: '0:58', publishedAt: '3 days ago', videoUrl: 'https://youtube.com/shorts/mocksh1' },
  ...
  youtubeFeaturedVideo: {
    id: 'yt_feat',
    title: 'Touring Marudhar Fashion Point - Sourcing & Crafting Elite Indian Footwear',
