      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="p-5 bg-white rounded-2xl border border-neutral-200/80 shadow-sm space-y-4">
            ...
            {/* Credential Inputs */}
            <div className="mb-4 p-4 bg-yellow-50 text-yellow-800 rounded-lg text-xs">
              <strong>Security Notice:</strong> The <em>Key Secret / API Secret</em> must be configured securely on your server via the <code>RAZORPAY_KEY_SECRET</code> environment variable. It has been removed from this dashboard to prevent security exposure.
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  placeholder="Only if required by Gateway"
                  className="w-full bg-neutral-50 border border-neutral-300 rounded-xl py-2.5 px-3.5 font-mono text-xs text-neutral-900 focus:ring-2 focus:ring-emerald-600 outline-none"
                />
              </div>
            </div>
